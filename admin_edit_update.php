		...
		$sql = "UPDATE user SET  User_Position = '$User_Position', User_Department = '$User_Department', User_Gender = '$User_Gender', User_DOB = '$User_DOB',
        User_Tel = '$User_Tel',User_Email = '$User_Email',User_Address = '$User_Address',User_Quota = '$User_Quota',
        User_Username = '$User_Username',User_Password = '$User_Password' WHERE User_ID = '$User_ID'";
